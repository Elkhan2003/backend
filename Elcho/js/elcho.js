!(function (e, t) {
	...
	let ge = { thead: [1, "<table>", "</table>"], col: [2, "<table><colgroup>", "</colgroup></table>"], tr: [2, "<table><tbody>", "</tbody></table>"], td: [3, "<table><tbody><tr>", "</tr></tbody></table>"], _default: [0, "", ""] };
	function ye(e, t) {
		let n;
	...
	function Oe(e, t, n) {
		for (let r, i = t ? S.filter(t, e) : e, o = 0; null != (r = i[o]); o++) n || 1 !== r.nodeType || S.cleanData(ye(r)), r.parentNode && (n && ie(r) && ve(ye(r, "script")), r.parentNode.removeChild(r));
		return e;
	}
	S.extend({
		...
		S.fn.extend({
			...
			empty: function () {
				for (let e, t = 0; null != (e = this[t]); t++) 1 === e.nodeType && (S.cleanData(ye(e, !1)), (e.textContent = ""));
				return this;
			},
			clone: function (e, t) {
				return (
	...
	let ze = ["Webkit", "Moz", "ms"],
		Ue = E.createElement("div").style,
		Xe = {};
	function Ve(e) {
		let t = S.cssProps[e] || Xe[e];
		return (
			t ||
			(e in Ue
				? e
	...
	function ct(e, t, n) {
		for (let r, i = (ft.tweeners[t] || []).concat(ft.tweeners["*"]), o = 0, a = i.length; o < a; o++) if ((r = i[o].call(n, t, e))) return r;
	}
	function ft(o, e, t) {
		let n,
			a,
			...
			u = function () {
				if (a) return !1;
				for (let e = tt || ut(), t = Math.max(0, l.startTime + l.duration - e), n = 1 - (t / l.duration || 0), r = 0, i = l.tweens.length; r < i; r++) l.tweens[r].run(n);
			...
			l = s.promise({
				...
				createTween: function (e, t) {
					let n = S.Tween(o, l.opts, e, t, l.opts.specialEasing[e] || l.opts.easing);
	...
	(S.Animation = S.extend(ft, {
		...
		tweener: function (e, t) {
			...
			for (let n, r = 0, i = e.length; r < i; r++) (n = e[r]), (ft.tweeners[n] = ft.tweeners[n] || []), ft.tweeners[n].unshift(t);
		},
		prefilters: [
			function (e, t, n) {
				let r,
		...
		(S.speed = function (e, t, n) {
			let r = e && "object" == typeof e ? S.extend({}, e) : { complete: n || (!n && t) || (m(e) && e), duration: e, easing: (n && t) || (t && !m(t) && t) };
			return (
